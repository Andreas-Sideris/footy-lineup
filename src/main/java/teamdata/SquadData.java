...
public class SquadData {
    ...
    public SquadData() {
        ...
        squad.put(33, new Player("Ben Davies", Position.CB, 33));
        squad.put(37, new Player("Micky van de Ven", Position.CB, 37));
        ...
        // Forwards
        squad.put(9, new Player("Richarlison", Position.ST, 9));
